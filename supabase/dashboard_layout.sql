-- ════════════════════════════════════════════════════════════════════════════
-- Home dashboard — modular layout. couples.dashboard_layout is an ordered jsonb
-- array of { id, size } (size: 'full' | 'half') the couple can customise. null =
-- use the app default. get_home_data returns it on the couple object.
-- Idempotent. Run after home_free_grouped.sql.
-- ════════════════════════════════════════════════════════════════════════════

alter table couples add column if not exists dashboard_layout jsonb;
